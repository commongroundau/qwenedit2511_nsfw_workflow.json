# qwenedit2511_nsfw_workflow.json

Dockerized ComfyUI workflow: QwenEdit2511_NSFW_workflow.json
...
docker build -t qwenedit2511_nsfw_workflow.json .

# Run the container
docker run -p 8188:8188 qwenedit2511_nsfw_workflow.json
```
